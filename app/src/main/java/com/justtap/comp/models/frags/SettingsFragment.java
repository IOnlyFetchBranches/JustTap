...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //Return our play layout
        View view = inflater.inflate(
                R.layout.menu_settings, container, false);

        //Get label (Fingers crossed this works)
        TextView label = (TextView) view.findViewById(R.id.MENU_settings_label);
        ImageButton button = (ImageButton) view.findViewById(R.id.MENU_settings_button);
